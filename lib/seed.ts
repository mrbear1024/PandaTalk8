...
export const SEED_COMMUNITIES: Community[] = [
  {
    ...
    join_instructions: "微信搜索公众号 就叫熊老板，发送「X增长」获取加入方式。",
    cta_label: "查看加入方式",
    sort_order: 1,
    featured: true,
    status: "published",
  },
  {
    ...
    description:
      "熊老板的 AI 学习圈是知识星球社群，持续分享 AI 工具、工作流、产品案例和创作者实践，适合想把 AI 真正用进工作和产品里的人。",
    ...
    join_instructions: "微信扫码加入知识星球「熊老板的 AI 学习圈」，或搜索公众号 就叫熊老板 发送「AI学习圈」获取加入方式。",
    cta_label: "查看加入方式",
    sort_order: 2,
    featured: false,
    status: "published",
  },
  {
    ...
    join_instructions: "微信扫码加入知识星球「X 冷启动成长群」，或搜索公众号 就叫熊老板 发送「冷启动」获取加入方式。",
    cta_label: "查看加入方式",
    sort_order: 3,
    featured: false,
    status: "published",
